...
INSERT INTO services (id, name, description, price, price_text, duration, duration_text, is_active, category_id, created_by_mechanic_id, created_at, updated_at) VALUES
  ...
  ('srv_brake_pads_front', 'Заміна гальмівних колодок (передні)', 'Заміна передніх колодок, огляд супортів, перевірка напрямних', NULL, 'від 700 грн', NULL, '45-120 хв', 1, 'cat_brakes', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('srv_brake_pads_rear', 'Заміна гальмівних колодок (задні)', 'Заміна задніх колодок, огляд механізму, перевірка супортів', NULL, 'від 700 грн', NULL, '45-120 хв', 1, 'cat_brakes', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('srv_brake_discs_front', 'Заміна гальмівних дисків (передні)', 'Заміна передніх дисків (вісь), перевірка биття, очищення маточини', NULL, 'від 1400 грн', NULL, '90-180 хв', 1, 'cat_brakes', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('srv_brake_discs_rear', 'Заміна гальмівних дисків (задні)', 'Заміна задніх дисків (вісь), перевірка биття, очищення маточини', NULL, 'від 1400 грн', NULL, '90-180 хв', 1, 'cat_brakes', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('srv_brake_pads', 'Заміна гальмівних колодок (загальна)', 'Заміна колодок (перед/зад) без деталізації (універсальна послуга)', NULL, 'від 600 грн', NULL, '40-120 хв', 1, 'cat_brakes', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('srv_brake_discs', 'Заміна гальмівних дисків (загальна)', 'Заміна дисків (вісь) без деталізації (універсальна послуга)', NULL, 'від 1200 грн', NULL, '90-180 хв', 1, 'cat_brakes', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
