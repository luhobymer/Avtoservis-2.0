...
- OCR/розпізнавання номерного знака тимчасово **вимкнено** у веб-клієнті.
- Додавання авто працює в режимі: завантаження фото + ручне заповнення полів.
- Фото авто зберігається під час створення/редагування авто без залежності від OCR.
