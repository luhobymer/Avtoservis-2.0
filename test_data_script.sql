...
('vvvv1111-1111-1111-1111-111111111111', 'USER_ID_1', 'WBAVA31070NL12345', 'BMW', 'X3', 2020, 'Чорний', 'AA1234BB', 45000),
('vvvv2222-2222-2222-2222-222222222222', 'USER_ID_2', 'WVWZZZ1JZ3W123456', 'Volkswagen', 'Passat', 2019, 'Сірий', 'BB5678CC', 62000),
('vvvv3333-3333-3333-3333-333333333333', 'USER_ID_3', 'KMHJ281DPMU123456', 'Hyundai', 'Elantra', 2021, 'Білий', 'CC9012DD', 28000),
('vvvv4444-4444-4444-4444-444444444444', 'USER_ID_4', 'JF1SJ5LC5DG123456', 'Subaru', 'Forester', 2018, 'Синій', 'DD3456EE', 78000);
...
('appt1111-1111-1111-1111-111111111111', 'USER_ID_1', 'WBAVA31070NL12345', 'Заміна масла', '2024-01-15 10:00:00+02', 'completed', '2024-01-15'),
('appt2222-2222-2222-2222-222222222222', 'USER_ID_2', 'WVWZZZ1JZ3W123456', 'Діагностика двигуна', '2024-01-20 14:30:00+02', 'completed', '2024-01-20'),
('appt3333-3333-3333-3333-333333333333', 'USER_ID_3', 'KMHJ281DPMU123456', 'Заміна гальмівних колодок', '2024-01-25 09:15:00+02', 'confirmed', '2024-01-25'),
('appt4444-4444-4444-4444-444444444444', 'USER_ID_4', 'JF1SJ5LC5DG123456', 'Розвал-схождення', '2024-01-30 16:00:00+02', 'pending', '2024-01-30');
...
('notif111-1111-1111-1111-111111111111', 'USER_ID_1', 'Ваш запис на заміну масла підтверджено на 15.01.2024 о 10:00', true, 'Запис підтверджено', 'appointment_reminder', 'sent', '{"appointment_id": "appt1111-1111-1111-1111-111111111111"}'),
('notif222-2222-2222-2222-222222222222', 'USER_ID_2', 'Діагностика вашого автомобіля завершена. Результати в особистому кабінеті', false, 'Діагностика завершена', 'maintenance_reminder', 'sent', '{"service_id": "hist2222-2222-2222-2222-222222222222"}'),
('notif333-3333-3333-3333-333333333333', 'USER_ID_3', 'Нагадування: через тиждень запланована заміна гальмівних колодок', false, 'Нагадування про запис', 'appointment_reminder', 'pending', '{"appointment_id": "appt3333-3333-3333-3333-333333333333"}'),
('notif444-4444-4444-4444-444444444444', 'USER_ID_4', 'Рекомендуємо провести заміну ременя ГРМ найближчим часом', false, 'Рекомендація по ТО', 'maintenance_reminder', 'pending', '{"recommendation": "timing_belt_replacement"}');
...
('rev11111-1111-1111-1111-111111111111', 'hist1111-1111-1111-1111-111111111111', 'USER_ID_1', 5, 'Відмінний сервіс! Швидко та якісно замінили масло. Рекомендую!', true),
('rev22222-2222-2222-2222-222222222222', 'hist2222-2222-2222-2222-222222222222', 'USER_ID_2', 4, 'Професійна діагностика, все пояснили детально. Ціна адекватна.', true),
('rev33333-3333-3333-3333-333333333333', 'hist3333-3333-3333-3333-333333333333', 'USER_ID_3', 5, 'Дуже задоволений роботою механіка. Гальма працюють ідеально!', true);
...
('mile1111-1111-1111-1111-111111111111', 'WBAVA31070NL12345', 'USER_ID_1', 45500, 'approved'),
('mile2222-2222-2222-2222-222222222222', 'WVWZZZ1JZ3W123456', 'USER_ID_2', 62300, 'pending'),
('mile3333-3333-3333-3333-333333333333', 'KMHJ281DPMU123456', 'USER_ID_3', 28200, 'approved');
...
1. Замініть всі 'USER_ID_1', 'USER_ID_2', 'USER_ID_3', 'USER_ID_4' на реальні UUID користувачів з вашої БД
